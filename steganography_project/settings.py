...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'pixelthorn1@gmail.com'       # ← your Gmail address
EMAIL_HOST_PASSWORD = 'oxvt ibvb lhgm peof'    # ← Gmail App Password (NOT your login password)
DEFAULT_FROM_EMAIL = 'pixelthorn1@gmail.com'
